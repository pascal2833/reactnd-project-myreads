...
- This project is related with the Udacity formation / react.
- All the basic css and html was done to focus only on the js part.
...
#### See quickly our books:

- First page shows the books that we:
...
To simplify development process, Udacity provided a backend server to develop against. The provided file [`BooksAPI.js`](src/BooksAPI.js) contains the methods needed to perform necessary operations on the backend:
